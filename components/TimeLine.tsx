                ...
                <div className="-my-6">
                    {dataAboutPage.map((data) => (
                        <div key={data.id} className="relative py-6 pl-8 sm:pl-32 group">
                            <h3 className="mb-1 text-2xl font-bold sm:mb-0">{t(data.titleKey)}</h3>
                            <div className="flex flex-col sm:flex-row items-start mb-1 
                                ...
                                <p className="text-xl font-bold text-gray-400">{t(data.subtitleKey)}</p>
                            </div>
                            <p className="text-slate-400 max-w-md">{t(data.descriptionKey)}</p>
                        </div>
                    ))}
                </div>
            </div>
